"""Worker HTTP app factory (no production composition — injectable handler)."""
...
def create_worker_app(
    *,
    ...
    In production, pass a wired AmendmentWorkerHandler via create_production_worker_app().
    """
    configure_logging()
